...
public class FindCheckActivity extends AppCompatActivity {

    Firebase firebase;
    String DB_URL = "https://mjucome-21a2b.firebaseio.com/find_img";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ctitle=(TextView)findViewById(R.id.findCheck_title);
        ccategory=(TextView)findViewById(R.id.findCheck_category);
        clocation=(TextView)findViewById(R.id.findCheck_location);
        cimageView=(ImageView)findViewById(R.id.findCheck_imageView);
        ctextView=(TextView)findViewById(R.id.findCheck_textView);
