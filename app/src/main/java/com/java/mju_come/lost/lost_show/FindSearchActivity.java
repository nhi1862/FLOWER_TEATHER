...
import com.java.mju_come.lost.Check.FindCheckActivity;
...
public class FindSearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview = (ListView)findViewById(R.id.f_search_listview);
        firebaseClient = new FirebaseClient(this, DB_URL, listview);
        firebaseClient.refreshdata();

        myAdapter = new ArrayAdapter<String>(FindSearchActivity.this,
                android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.search_category));
        mySpinner = (Spinner) findViewById(R.id.f_spinner_category);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(getApplicationContext(), FindCheckActivity.class);
